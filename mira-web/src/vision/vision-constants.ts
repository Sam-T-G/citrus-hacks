// Ported from visual-cue-tracker/src/lib/constants.ts
export const CUE_NAMES: Record<string, string> = {
  ...
  'approach_detected':       'Approached Camera',
  'looking_around_confused': 'Looking Around (Confused)',
};

export type SocialState =
  | 'friendly' | 'engaged' | 'concerned'
  | 'confused'  | 'disagreeing' | 'disengaged' | 'neutral';
...
// Cues that represent distress or safety concern — trigger immediate visual check
export const SAFETY_CUES = new Set([
  'fall_suspected', 'body_horizontal',
]);

// Cues that warrant a wandering alert
export const WANDERING_CUES = new Set(['facing_away']);
