...
const int UP   = 15;  // degrees — pin raised
...
void loop() {
  ...
  //create fn that keeps memory on buttons pressed
  //create fn for submitting memory to process button input.
  //consider space button
  //consider backspace 
